...
const index = () => {
  ...
  const handlesubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast.success(t("Job posted successfully"));
      router.push("/adminpanel");
    } catch (error) {
      console.log(error);
      toast.error(t("error posting job"));
    } finally {
      setisloading(false);
    }
  };
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder={t("e.g. Tech Solutions Inc")}
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder={t("e.g. Mumbai, India")}
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className=" text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                    placeholder={t("e.g. Software Development")}
                  />
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  placeholder={t("Describe the company...")}
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={4}
                  className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  placeholder={t("Describe the internship role...")}
                />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="text-black mt-1 block w-full rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:ring-blue-500 sm:text-sm"
                  placeholder={t("Eligibility criteria...")}
                />
              </div>
