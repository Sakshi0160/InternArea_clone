...
export default function SvgSlider() {
  ...
  const slides = [
    {
      pattern: "pattern-1",
      title: t("StartyourCareerJourney"),
      bgColor: "bg-indigo-600",
    },
    {
      pattern: "pattern-2",
      title: t("LearnFromTheBest"),
      bgColor: "bg-blue-600",
    },
    {
      pattern: "pattern-3",
      title: t("GrowYourSkills"),
      bgColor: "bg-purple-600",
    },
    {
      pattern: "pattern-4",
      title: t("ConnectWithTopCompanies"),
      bgColor: "bg-teal-600",
    },
  ];

  const stats = [
    { number: t("Cnumber"), label: t("companiesHiring") },
    { number: t("Nnumber"), label: t("newOpenings") },
    { number: t("Anumber"), label: t("activeStudents") },
    { number: t("Lnumber"), label: t("learners") },
  ];
...
useEffect(() => {
  const fetchData = async () => {
    try {
      ...
      console.log("Internships:", internshipRes.data);
      console.log("Jobs:", jobRes.data);

      setinternship(internshipRes.data);
      setjob(jobRes.data);
    } catch (error) {
      console.error("Error fetching internships/jobs:", error);
    }
  };
